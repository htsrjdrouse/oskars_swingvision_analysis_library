...
function shotdisplay($fplayer,$fplayer_range,$splayer,$splayer_range, $myshotsA, $myshotsB){
	$shottypery=array("Forehand", "Backhand", "Serve", "FH Volley", "BH Volley", "Overhead");
...
?>
 ...
 <? direction_display($shottype,$typeshot); ?>
...
function direction_display($shottype,$typeshot){
...
function direction_shot($myshots, $shottype){
 $nodirection = array();
 $downtheline = array();
 $crosscourt = array();
 $insideout = array();
